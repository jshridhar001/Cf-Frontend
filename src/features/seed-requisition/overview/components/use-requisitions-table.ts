...
import {
  columns,
  type RequisitionsTableMeta,
} from '@/features/seed-requisition/overview/components/columns';
import { features } from '@/features/seed-requisition/overview/components/data-table-features';
import {
...
function statusColumnFilters(
  ...
  status: SeedRequisitionStatus | undefined,
): ColumnFiltersState {
...
export function useRequisitionsTable({
  data,
  pagination,
  onPaginationChange,
  meta,
...
export type RequisitionsTable = ReturnType<typeof useRequisitionsTable>;
