...
export function DataTable({ table }: { table: RequisitionsTable }) {
            ...
            rows.map((row) => (
              ...
              >
                {row.getAllCells().map((cell) => {
                  ...
                  // Group headers: only Bags/Acres sums — other columns without
                  // aggregationFn would otherwise render the first leaf's values.
                  if (row.getIsGrouped()) {
