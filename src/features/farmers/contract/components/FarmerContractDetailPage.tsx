...
import { ContractPdfViewer } from '@/features/farmers/contract/components/contract-pdf-viewer';
import {
  CONTRACT_LANGUAGES,
  type ContractLanguage,
} from '@/features/farmers/contract/lib/contract-language';
...
const GeneratedContractPdf = lazy(() =>
  import('@/features/farmers/contract/components/generated-contract-pdf').then((mod) => ({
