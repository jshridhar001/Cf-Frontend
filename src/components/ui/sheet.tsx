...
function SheetContent({
  ...
  const isComboboxEvent = (event: { target: EventTarget | null }) =>
    event.target instanceof Element && Boolean(event.target.closest("[data-slot=combobox-content]"))
    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        onPointerDownOutside={(event) => {
          if (isComboboxEvent(event)) event.preventDefault()
          onPointerDownOutside?.(event)
        }}
        ...
        {...props}
      >
        <ComboboxPortalContainer container={portalContainer}>
          {children}
          {showCloseButton && (
